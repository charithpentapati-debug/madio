...
export const FurnitureCategoryPage: React.FC = () => {
  ...
  // isPopulated tracks the static PDF catalogue only (e.g. Bar Chairs is
  // false because its 24 source images are unusable branded catalogue crops
  ...
  return (
    <div className="bg-[#FAFAF7]">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-16">
        ...
        {visibleProducts.length === 0 ? (
          // Nothing to show yet — neither catalogue nor client uploads
