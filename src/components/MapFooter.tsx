    ...
    <footer className="bg-[#2C2C2C] text-[#FAFAF7] pt-20 pb-8 border-t border-[#3D3D3D]">
      <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
        ...
        <div className="flex flex-col space-y-6">
          <div>
            <Link to="/map">
              <img src={mapLogo} alt="MAP" className="h-[30px] w-auto brightness-0 invert" />
            </Link>
          </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-xs text-[#C4B9A8] font-light">
            <li><Link to="/map/products?collection=cimento" className="hover:text-white transition-colors duration-300">Cimento (Microcement)</Link></li>
            <li><Link to="/map/products?collection=marbre" className="hover:text-white transition-colors duration-300">Marbre (Venetian Plaster)</Link></li>
            <li><Link to="/map/products?collection=matt-decor" className="hover:text-white transition-colors duration-300">Matt Decor (Colour Wash)</Link></li>
            <li><Link to="/map/products?collection=pearl-burst" className="hover:text-white transition-colors duration-300">Pearl Burst (Metallic Pearl)</Link></li>
            <li><Link to="/map/products?collection=metallics-2d" className="hover:text-white transition-colors duration-300">2D Metallics (Pearl Gloss)</Link></li>
          </ul>
        </div>
